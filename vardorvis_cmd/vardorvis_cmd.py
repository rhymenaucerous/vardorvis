...
class VardorvisCmd(Cmd):
    ...
    def precmd(self, statement):
        """
        Hook called before a command is executed. We can update to alter the command before it is executed.
        This logs the executed command to a file.
        """
